 ...
 * @date    2026-01-28
 */
#ifndef OLD_S_CURVE_HPP
#define OLD_S_CURVE_HPP
#include <cstdint>
#include "old_ivelocity.hpp"

// 最大二分查找误差
#ifndef OLD_S_CURVE_MAX_BS_ERROR
#    define OLD_S_CURVE_MAX_BS_ERROR (0.001f)
#endif

namespace scurve_old
{
